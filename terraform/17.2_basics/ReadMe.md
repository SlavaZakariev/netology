...
Стандартизировал код с учётом обеих ВМ, двух сетей и файлов с переменными:

<details>
<summary>Файл провайдера provaider.tf</summary>
...
<details>
<summary>Файл отображение данных о ВМ outputs.tf</summary>
...
<details>
<summary>Результат команды terraform plan</summary>

```terraform
data.yandex_compute_image.ubuntu-db: Reading...
data.yandex_compute_image.ubuntu-web: Reading...
data.yandex_compute_image.ubuntu-web: Read complete after 0s [id=fd8t849k1aoosejtcicj]
data.yandex_compute_image.ubuntu-db: Read complete after 0s [id=fd8t849k1aoosejtcicj]
...
Terraform will perform the following actions:
  ...
  # yandex_vpc_network.db will be created
  + resource "yandex_vpc_network" "db" {
      + created_at                = (known after apply)
  ...
  # yandex_vpc_network.web will be created
  + resource "yandex_vpc_network" "web" {
      + created_at                = (known after apply)
      + default_security_group_id = (known after apply)
      + folder_id                 = (known after apply)
  ...
  # yandex_vpc_subnet.db_subnet will be created
  + resource "yandex_vpc_subnet" "db_subnet" {
      + created_at     = (known after apply)
      + folder_id      = (known after apply)
      + id             = (known after apply)
  ...
  # yandex_vpc_subnet.web_subnet will be created
  + resource "yandex_vpc_subnet" "web_subnet" {
      + created_at     = (known after apply)
      + folder_id      = (known after apply)
      + id             = (known after apply)
...
Changes to Outputs:
  + VMs_data = {
      + external_ip1 = (known after apply)
      + external_ip2 = (known after apply)
      + fqdn_name1   = (known after apply)
      + fqdn_name2   = (known after apply)
      + vm_name1     = "netology-develop-platform-web"
      + vm_name2     = "netology-develop-platform-db"
    }
