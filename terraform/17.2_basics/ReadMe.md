...
Стандартизировал код с учётом обеих ВМ, двух сетей и файлов с переменными: [Git](https://github.com/SlavaZakariev/netology/tree/main/terraform/17.2_basics/git)
